...
public class RhCepId implements Serializable {
    ...
    public RhCepId(Long cidade, Long distrito, Long logradouro, Long numero_ini) {
        this.cidade = cidade;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RhCepId that)) return false;
